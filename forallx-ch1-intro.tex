...
Ez egy \define{induktív} érvelés, mivel több esetből általánosít és levon egy következtetést az összes esetből.
...
\end{earg}
A két kijelentés kontingens, mivel lehet hogy John nem ment boltba vagy nem mosogatott edényeket. Mégis ugyanolyan igazságértékük kell legyen. Ha bármely kijelentés igaz, akkor mindkettő igaz; ha bármely kijelentés hamis, akkor mindkettő hamis. Amikor két kijelentésnek szükségszerűen azonos igazságértéke van, azt mondjuk, hogy \define{logikailag ekvivalensek}.
...
Ha egy kijelentéskészlet nem lehet egyszerre igaz, mint például a B1--B22, akkor azt mondjuk, hogy \define{inkonzisztens}. Egyéb esetben \define{konzisztens}.
...
Íme egy híres megalapozott érvelés:
\begin{earg}
\item[] Socrates egy ember.
\item[] Minden ember halandó
\item[\therefore] Socrates halandó.
\end{earg}
Ez egy beton kemény érvelés. Az egyik alapvetés kétségbe vonásával vagy képes megcáfolni a konklúziót – a logikus formája kifogástalan. Mi a helyzet a következő érveléssel?
...
\item[\therefore] Socrates egy répa.
\end{earg}
...
\begin{earg}
\item[] $S$ az $M$.
\item[] Minden $M$-ek $C$-k.
\item[\therefore] $S$ az $C$.
\end{earg}

Mindkét érvelésben az $S$ Socratest, az $M$ pedig embert jelképez. Az első érvelésben, $C$ halandót; a másodikban $C$ répát jelképez. Mindkét érvelésnek megvan ez az alakja, és minden érvelés ebben a formában érvényes.
...
Amit mi itt tettünk az az volt, hogy kicseréltünk szavakat, mint ’ember’ vagy ’répa’ olyan szimbólumokkal, mint $M$ vagy $C$ azért, hogy világossá tegyük a logikus alakot. Ez a központi ötlet a formális logika mögött. 
